...
function ppn_publish_post_notification_remove_access_capabilities(){
      ...
      if($postType=="post" ){  
           ...
           if('publish' != $old_status){
             ...
             if($meta_values!='yes'){
                ...
                $subject=sanitize_text_field($publish_post_notification_settings['subject']);
                $from_name=sanitize_text_field($publish_post_notification_settings['from_name']);
                $from_email=sanitize_email($publish_post_notification_settings['from_email']);
                $emailBody=$publish_post_notification_settings['emailBody'];
                $emailBody=wp_kses_post($emailBody);
  ...
  if(isset($_POST['savesettings'])){
       ...
       $retrieved_nonce = '';
        ...
        if(isset($_POST['save_email_ns_settings']) and $_POST['save_email_ns_settings']!=''){

            $retrieved_nonce=sanitize_text_field($_POST['save_email_ns_settings']);

        }
        if (!wp_verify_nonce($retrieved_nonce, 'action_settings_nonce' ) ){
     ...
     <div style="float:left;" >
        ...
        <tbody>
          <tr valign="top" id="subject">
             ...
             <td>    
                <input type="text" id="email_subject" name="email_subject" value="<?php echo isset($publish_post_notification_settings['subject'])?esc_html(esc_attr(stripslashes($publish_post_notification_settings['subject']))):'';?>"  class="valid" size="70">
           ...
           <tr valign="top" id="subject">
             ...
             <td>    
                <input type="text" id="email_From_name" name="email_From_name"  value="<?php echo isset($publish_post_notification_settings['from_name'])?esc_html(esc_attr(stripslashes($publish_post_notification_settings['from_name']))):'';?>" class="valid" size="70">
           ...
           <tr valign="top" id="subject">
             ...
             <td>    
                <input type="text" id="email_From" name="email_From" value="<?php echo isset($publish_post_notification_settings['from_email']) ? esc_html(esc_attr(stripslashes($publish_post_notification_settings['from_email']))):'';?>"  class="valid" size="70">
           ...
           <tr valign="top" id="subject">
             ...
             <td> 
                <?php wp_nonce_field('action_settings_nonce','save_email_ns_settings'); ?>
