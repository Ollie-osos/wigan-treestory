                ...
                if (get_row_layout() == 'profile_image') :
                    if (have_rows('profiles')) : ?>
                        <?php while (have_rows('profiles')) : the_row();
                            $about_profile_image = get_sub_field('about_profile_image') ? : null;
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4 col-lg-4 profile">
                                    <div class="image">
                                        <?php if ( ! empty( $about_profile_image ) && ! empty( $about_profile_image['sizes']['medium'] ) ) : ?>
                                            <img src="<?php echo esc_url( $about_profile_image['sizes']['medium'] ); ?>" alt="<?php echo esc_attr( ! empty( $about_profile_image['alt'] ) ? $about_profile_image['alt'] : '' ); ?>">        
                                        <?php endif; ?>
                                    </div>
                                </div>
